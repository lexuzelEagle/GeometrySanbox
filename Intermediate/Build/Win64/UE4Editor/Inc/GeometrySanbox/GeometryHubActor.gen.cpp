...
#include "GeometrySanbox/Public/GeometryHubActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GEOMETRYSANBOX_API UScriptStruct* Z_Construct_UScriptStruct_FGeometryPayload();
	...
	GEOMETRYSANBOX_API UClass* Z_Construct_UClass_AGeometryHubActor_NoRegister();
	GEOMETRYSANBOX_API UClass* Z_Construct_UClass_AGeometryHubActor();
...
class UScriptStruct* FGeometryPayload::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern GEOMETRYSANBOX_API uint32 Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryPayload, Z_Construct_UPackage__Script_GeometrySanbox(), TEXT("GeometryPayload"), sizeof(FGeometryPayload), Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash());
	}
	return Singleton;
}
template<> GEOMETRYSANBOX_API UScriptStruct* StaticStruct<FGeometryPayload>()
{
	return FGeometryPayload::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FGeometryPayload(FGeometryPayload::StaticStruct, TEXT("/Script/GeometrySanbox"), TEXT("GeometryPayload"), false, nullptr, nullptr);
static struct FScriptStruct_GeometrySanbox_StaticRegisterNativesFGeometryPayload
{
	FScriptStruct_GeometrySanbox_StaticRegisterNativesFGeometryPayload()
	{
		UScriptStruct::DeferCppStructOps<FGeometryPayload>(FName(TEXT("GeometryPayload")));
	}
} ScriptStruct_GeometrySanbox_StaticRegisterNativesFGeometryPayload;
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeometryPayload_Hash() { return 2094458528U; }
	...
	IMPLEMENT_CLASS(AGeometryHubActor, 3491474339);
	template<> GEOMETRYSANBOX_API UClass* StaticClass<AGeometryHubActor>()
	{
		return AGeometryHubActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGeometryHubActor(Z_Construct_UClass_AGeometryHubActor, &AGeometryHubActor::StaticClass, TEXT("/Script/GeometrySanbox"), TEXT("AGeometryHubActor"), false, nullptr, nullptr, nullptr);
