...
#define UE_PROJECT_NAME GeometrySanbox
#define UE_TARGET_NAME GeometrySanboxEditor
#define UE_MODULE_NAME "GeometrySanbox"
...
#define GEOMETRYSANBOX_API DLLEXPORT
